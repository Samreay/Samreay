...
},{}],"node_modules/cruip-js-toolkit/lib/focusHandling.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.focusHandling = void 0;
...
exports.focusHandling = focusHandling;
},{}],"node_modules/cruip-js-toolkit/lib/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
Object.defineProperty(exports, "focusHandling", {
  enumerable: true,
  get: function () {
    return _focusHandling.focusHandling;
  }
});

var _focusHandling = require("./focusHandling.js");
},{"./focusHandling.js":"node_modules/cruip-js-toolkit/lib/focusHandling.js"}],"node_modules/aos/dist/aos.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
var _cruipJsToolkit = require("cruip-js-toolkit");
...
window.AOS = _aos.default; // import component from './components/component';

document.addEventListener("DOMContentLoaded", function () {
  (0, _cruipJsToolkit.focusHandling)("outline");
});

function updateCardVars(card, x, y) {
  ...
  var hyp = Math.sqrt(normCenter.x * normCenter.x + normCenter.y * normCenter.y);

  if (hyp > 1.3) {
    hyp = hyp * Math.exp(-3 * (hyp - 1.3));
  }

  hyp = Math.min(hyp, 1.2);

  function calcAngle(x) {
    return x * Math.exp(-10 * Math.max(0, Math.abs(x) - 1));
  }
...
},{"alpinejs":"node_modules/alpinejs/dist/alpine.js","cruip-js-toolkit":"node_modules/cruip-js-toolkit/lib/index.js","aos":"node_modules/aos/dist/aos.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
