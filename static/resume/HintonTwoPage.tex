...
\wbindent{Communication:}{Experience communicating complex topics effectively in radio, TV (recorded + live), public lectures and presentations. }
\wbindent{Publications:}{6 first author, 45+ contributing author. Areas of software, statistics, astrophysics.}
\end{entrylist}
% \section{References}
% 
% \begin{entrylist}
