...
My move from astrophysics into machine learning and sustainability is driven by a desire
to try and explore problem areas with direct impact on the world. My core scientific
philosophy is that a product is more useful than a paper. Make analyses and implementations
accessible, packaged, documented, tested, and reproducible, 
and you've made ten times the impact.\\
...
\begin{itemize}
	\item Designed and productionised \highlight{probabilistic time-series forecasting} models for UK energy markets.
...
\begin{itemize}
\item Continued research in the areas of supernova cosmology and large scale structure, focusing heavily upon analysis pipelines and 
...
\item Increased efficiency of cosmological analysis by two orders of magnitude.
\end{itemize}
}
\end{entrylist}
\begin{entrylist}
