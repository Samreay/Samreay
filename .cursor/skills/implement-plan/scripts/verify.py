...
Usage:
    uv run .cursor/skills/implement-plan/scripts/verify.py --phase N
    uv run .cursor/skills/implement-plan/scripts/verify.py --phase N --keep-normalized
    uv run .cursor/skills/implement-plan/scripts/verify.py --phase N --update-baselines
