...
rmdir thumbs
mkdir thumbs
magick %img% -sampling-factor 4:2:0 -strip -quality 70 -resize 255x175\! -interlace Plane -crop 255x175+0+0 +repage thumb_card.jpg
magick %img% -sampling-factor 4:2:0 -strip -quality 70 -resize 500x250\! -interlace Plane -crop 500x250+0+0 +repage thumb_fb.jpg
