...
Full reference: [references/runes.md](references/runes.md). Quick rules:
...
Svelte 5 replaces named/scoped slots with **snippets**. See [references/snippets-and-events.md](references/snippets-and-events.md) for the full pattern catalogue. Quick rules:
...
Full details: [references/svelte-with-astro.md](references/svelte-with-astro.md). The non-negotiable rules:
