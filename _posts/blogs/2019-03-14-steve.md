...
desc: "A Hierarchical Bayesian model for supernova cosmology with the Dark Energy Survey."
date: 2019-03-14
categories: [blog]
tags: [python,project]
loc: 'blog/steve/'
...
{% include image.html url="example.jpg" class="img-reduced img-invert" %}
...
{% include image.html url="eff.jpg" class="img-invert" %}
...
{% include image.html url="pgm.jpg" class="img-reduced img-invert"  %}
...
{% include image.html url="corr.jpg" class=" img-invert" %}
...
{% include image.html url="contour.jpg" class="img-invert" %}
...
{% include image.html url="bbc_vs_bhm.jpg" class=" img-invert" %}
