...
desc: "Visualising the thousands of galaxies in modern surveys."
date: 2016-09-04
categories: [blog]
tags: [python,project]
loc: 'blog/surveyvis/'
...
{% include image.html url="all.jpg" class="img-reduced" %}
{% include image.html url="wigglez.jpg" class="img-reduced" %}
{% include image.html url="sdss.jpg" class="img-reduced" %}
{% include image.html url="6df.jpg" class="img-reduced" %}
{% include image.html url="2df.jpg" class="img-reduced" %}
