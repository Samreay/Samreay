// Ported verbatim from `themes/sams-theme/assets/css/tailwind.config.js` for
// the Astro build. `content` is repointed at `src/` and `content/` so Tailwind
// scans the new tree; everything else (safelist, theme.extend, plugins) stays
// identical so review-tier classes, fancy_card hover effects, and the Inter
// / Architects Daughter fonts behave the same.
module.exports = {
  content: [
