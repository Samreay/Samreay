...
- Implemented **MLOps** pipelines in AWS, including feature store, model versioning (mlflow), and model serving.

- Productionised **probabilistic time-series forecasting** models for UK energy markets.
...
- Created interactive **visualisations** of market opportunities (`matplotlib`, `plotly`, Dash, Streamlit).
...
*Doctorate of Philosophy* *in* *Astrophysics*
...
# Publications
I am an author on over 300 published articles, with the astronomy subset available through [**NASA ADS**](https://ui.adsabs.harvard.edu/search/q=%20author%3A%22hinton%2C%20s%22%20%20year%3A2014-2025&sort=citation_count%20desc%2C%20bibcode%20desc&p_=0). My medical publications via the Covid 19 Critical Care Consortium will not be indexed by NASA, but can be found on my [**Google scholar profile**](https://scholar.google.com/citations?user=5AE3D6kAAAAJ).
